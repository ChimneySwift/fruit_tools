...
local extra_drop_chance = 5
-- Maximum amount of extra drops (default is 5)
local extra_drop_max = 5
...
if minetest.get_modpath("mobs") then
    ...
    fruit_tools:register_throwing_food("fruit_tools", "farming:blueberries", "blueberry", 4, true, plant_whole)
